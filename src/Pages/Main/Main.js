...
class Main extends Component {
    ...
    setContents() {
        const contents = [
            ...
            {
                items: [
                    {img:"https://image.converse.co.kr/cmsstatic/structured-content/15195/img-converse-chucktaylor-1.jpg?gallery", title:"척테일러 올스타"},
                    {img:"https://image.converse.co.kr/cmsstatic/structured-content/15196/척70진짜최종.jpg?gallery", title:"척 70"},
                    {img:"https://image.converse.co.kr/cmsstatic/structured-content/15197/원스타진짜최종.jpg?gallery", title:"원스타"},
                    {img:"https://image.converse.co.kr/cmsstatic/structured-content/15198/잭퍼셀최종.jpg?gallery", title:"잭퍼셀"}
                ],
    ...
    makeGroup(contents) {
        ...
        contents.forEach(content => {
            if (content.type !== undefined) {
                if (content.type >= 4) { //type 4 이상, 독자 Contents 차지
