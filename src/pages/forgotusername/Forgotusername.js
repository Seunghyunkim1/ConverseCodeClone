            ...
            <div className="Forgotusername">
                 ...
                 <div className="idpwd-form">
                  ...
                  <button className="kakao-login">
                    <div className="speech-bubble">
                        <img src="https://image.flaticon.com/icons/svg/2462/2462844.svg" className="speech-bubbleimg" alt=""/>
                    </div>
                ...
                <form className="login-form">
                  <div className="field-firstlabel">
                    <input className="input-id" type="text" placeholder="전화번호를 입력하세요"  /> 
                  </div>

                <div className="field-secondlabel">
                    <input className="input-pwd"  type="password" placeholder="이름을 입력하세요" /> 
                </div>
                </form>
